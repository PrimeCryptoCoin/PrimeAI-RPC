...
A package that will help you do RPC calls from Node.js to your Primeai core node, that is your full Primeai node.

# Install
```
npm install @primeaiproject/primeai-rpc
```
# Example 
...
```
## Example list all generated addresses in a Wallet (Primeai core)
...
Here is a list of all method/commands [All methods](primeai_methods.md)

In your local Primeai core wallet, you can go to
