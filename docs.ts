...
/** bumpfee has been deprecated on the PrimeAI Wallet.**/
bumpfee:'bumpfee',
...
Examples:
> primeai-cli getrawmempool true
...
Examples:
> primeai-cli getrawtransaction "mytxid"
> primeai-cli getrawtransaction "mytxid" true
...
> primeai-cli getreceivedbyaccount ""

Amount received at the tabby account including unconfirmed amounts with zero confirmations
> primeai-cli getreceivedbyaccount "tabby" 0

The amount with at least 6 confirmations
> primeai-cli getreceivedbyaccount "tabby" 6
...
Arguments:
1. "address"         (string, required) The primeai address for transactions.
2. minconf             (numeric, optional, default=1) Only include transactions confirmed at least this many times.

Result:
amount   (numeric) The total amount in PrimeAI received at this address.

Examples:

The amount from transactions with at least 1 confirmation
> primeai-cli getreceivedbyaddress "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX"

The amount including unconfirmed transactions, zero confirmations
> primeai-cli getreceivedbyaddress "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" 0

The amount with at least 6 confirmations
> primeai-cli getreceivedbyaddress "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" 6
...
Examples:
> primeai-cli getsnapshotrequest "TRONCO" 12345
...
Examples:
> primeai-cli getspentinfo '{"txid": "0437cd7f8525ceed2324359c2d0ba26006d92d856a9c20fa0241106ee5a597c9", "index": 0}'
...
Result:
{
  "amount" : x.xxx,        (numeric) The transaction amount in PrimeAI
  "fee": x.xxx,            (numeric) The amount of the fee in PrimeAI. This is negative and only available for the 
  ...
  "details" : [
    {
      ...
      "address" : "address",          (string) The primeai address involved in the transaction
      "category" : "send|receive",    (string) The category, either 'send' or 'receive'
      "amount" : x.xxx,                 (numeric) The amount in PrimeAI
...
Examples:
> primeai-cli gettransaction "1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d"
> primeai-cli gettransaction "1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d" true
...
Result:
{
  ...
  "confirmations" : n,       (numeric) The number of confirmations
  "value" : x.xxx,           (numeric) The transaction value in PrimeAI
  "scriptPubKey" : {         (json object)
     "asm" : "code",       (string) 
     "hex" : "hex",        (string) 
     "reqSigs" : n,          (numeric) Number of required signatures
     "type" : "pubkeyhash", (string) The type, eg pubkeyhash
     "addresses" : [          (array of string) array of primeai addresses
        "address"     (string) primeai address
        ,...
     ]
  },
...
> primeai-cli listunspent 

View the details
> primeai-cli gettxout "txid" 1
...
Examples:
> primeai-cli getverifierstring "restricted_name"
...
Result:
{
  ...
  "walletversion": xxxxx,          (numeric) the wallet version
  "balance": xxxxxxx,              (numeric) the total confirmed balance of the wallet in PrimeAI
  "unconfirmed_balance": xxx,      (numeric) the total unconfirmed balance of the wallet in PrimeAI
  "immature_balance": xxxxxx,      (numeric) the total immature balance of the wallet in PrimeAI
  "txcount": xxxxxxx,              (numeric) the total number of transactions in the wallet
  "keypoololdest": xxxxxx,         (numeric) the timestamp (seconds since Unix epoch) of the oldest pre-generated key in the key pool
  "keypoolsize": xxxx,             (numeric) how many new keys are pre-generated (only counts external keys)
  "keypoolsize_hd_internal": xxxx, (numeric) how many new keys are pre-generated for internal use (used for change outputs, only appears if the wallet is using this feature, otherwise external keys are used)
  "unlocked_until": ttt,           (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked
  "paytxfee": x.xxxx,              (numeric) the transaction fee configuration, set in PrimeAI/kB
  "hdseedid": "<hash160>"          (string, optional) the Hash160 of the HD seed (only present when HD is enabled)
  "hdmasterkeyid": "<hash160>"     (string, optional) alias for hdseedid retained for backwards-compatibility. Will be removed in V0.18.
}

Examples:
> primeai-cli getwalletinfo 
...
> primeai-cli importaddress "myscript"

Import using a label without rescan
> primeai-cli importaddress "myscript" "testing" false
...
Examples:
> primeai-cli importmulti '[{ "scriptPubKey": { "address": "<my address>" }, "timestamp":1455191478 }, { "scriptPubKey": { "address": "<my 2nd address>" }, "label": "example 2", "timestamp": 1455191480 }]'
> primeai-cli importmulti '[{ "scriptPubKey": { "address": "<my address>" }, "timestamp":1455191478 }]' '{ "rescan": false}'
...
> primeai-cli importprivkey "mykey" "testing" false

Import using default blank label and without rescan
> primeai-cli importprivkey "mykey" "" false
...
> primeai-cli importpubkey "mypubkey"

Import using a label without rescan
> primeai-cli importpubkey "mypubkey" "testing" false
...
4. "change_address"        (string), optional, default=""), address the the primeai change will be sent to, if it is empty, change address will be generated for you
...
Examples:
> primeai-cli issue "ASSET_NAME" 1000
> primeai-cli issue "ASSET_NAME" 1000 "myaddress"
> primeai-cli issue "ASSET_NAME" 1000 "myaddress" "changeaddress" 4
> primeai-cli issue "ASSET_NAME" 1000 "myaddress" "changeaddress" 2 true
> primeai-cli issue "ASSET_NAME" 1000 "myaddress" "changeaddress" 8 false true QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E
> primeai-cli issue "ASSET_NAME/SUB_ASSET" 1000 "myaddress" "changeaddress" 2 true
> primeai-cli issue "ASSET_NAME#uniquetag"
**/
issue:'issue',
...
Examples:
> primeai-cli issuequalifierasset "#ASSET_NAME" 1000
> primeai-cli issuequalifierasset "ASSET_NAME" 1000 "myaddress"
> primeai-cli issuequalifierasset "#ASSET_NAME" 1000 "myaddress" "changeaddress"
> primeai-cli issuequalifierasset "ASSET_NAME" 1000 "myaddress" "changeaddress"
> primeai-cli issuequalifierasset "#ASSET_NAME" 1000 "myaddress" "changeaddress" true QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E
> primeai-cli issuequalifierasset "ASSET_NAME/SUB_QUALIFIER" 1000 "myaddress" "changeaddress"
> primeai-cli issuequalifierasset "#ASSET_NAME"
**/
...
5. "change_address"        (string, optional, default="") address that the primeai change will be sent to, if it is empty, change address will be generated for you
...
Examples:
> primeai-cli issuerestrictedasset "$ASSET_NAME" 1000 "#KYC & !#AML" "myaddress"
> primeai-cli issuerestrictedasset "$ASSET_NAME" 1000 "#KYC & !#AML" "myaddress"
> primeai-cli issuerestrictedasset "$ASSET_NAME" 1000 "#KYC & !#AML" "myaddress" "changeaddress" 5
> primeai-cli issuerestrictedasset "$ASSET_NAME" 1000 "#KYC & !#AML" "myaddress" "changeaddress" 8 true
> primeai-cli issuerestrictedasset "$ASSET_NAME" 1000 "#KYC & !#AML" "myaddress" "changeaddress" 0 false true QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E
**/
...
Five (5) PrimeAI will be burned for each asset created.
...
5. "change_address"        (string, optional, default=""), address the the primeai change will be sent to, if it is empty, change address will be generated for you

Result:
"txid"                     (string) The transaction id

Examples:
> primeai-cli issueunique "MY_ASSET" '["primo","secundo"]'
> primeai-cli issueunique "MY_ASSET" '["primo","secundo"]' '["first_hash","second_hash"]'
**/
...
Examples:
> primeai-cli isvalidverifierstring "verifier_string"
...
> primeai-cli listaccounts 

List account balances including zero confirmation transactions
> primeai-cli listaccounts 0

List account balances for 6 or more confirmations
> primeai-cli listaccounts 6
...
Examples:
> primeai-cli listaddressesbyasset "ASSET_NAME" false 2 0
> primeai-cli listaddressesbyasset "ASSET_NAME" true
> primeai-cli listaddressesbyasset "ASSET_NAME"
**/
...
Examples:
> primeai-cli listaddressesfortag "#TAG"
...
[
  [
    [
      "address",            (string) The primeai address
      amount,                 (numeric) The amount in PrimeAI
...
Examples:
> primeai-cli listaddressgroupings 
...
Examples:
> primeai-cli listaddressrestrictions "address"
...
Arguments:
1. "address"                  (string, required) a primeai address
...
Examples:
> primeai-cli listassetbalancesbyaddress "myaddress" false 2 0
> primeai-cli listassetbalancesbyaddress "myaddress" true
> primeai-cli listassetbalancesbyaddress "myaddress"
**/
...
> primeai-cli listassets ASSET
> primeai-cli listassets "ASSET*" true 10 20
**/
...
Examples:
> primeai-cli listglobalrestrictions 
...
> primeai-cli lockunspent false "[{\"txid\":\"a08e6907dbbd3d809776dbfc5d82e371b764ed838b5655e72f463568df1aadf0\",\"vout\":1}]"

List the locked transactions
> primeai-cli listlockunspent 

Unlock the transaction again
> primeai-cli lockunspent true "[{\"txid\":\"a08e6907dbbd3d809776dbfc5d82e371b764ed838b5655e72f463568df1aadf0\",\"vout\":1}]"
...
> primeai-cli listmyassets ASSET
> primeai-cli listmyassets "ASSET*" true 10 20
> primeai-cli listmyassets "ASSET*" true 10 20 1
**/
...
Examples:
> primeai-cli listreceivedbyaccount 
> primeai-cli listreceivedbyaccount 6 true
...
[
  {
    ...
    "amount" : x.xxx,                  (numeric) The total amount in PrimeAI received by the address
    "confirmations" : n,               (numeric) The number of confirmations of the most recent transaction included
    "label" : "label",               (string) A comment for the address/transaction, if any
    "txids": [
...
Examples:
> primeai-cli listreceivedbyaddress 
> primeai-cli listreceivedbyaddress 6 true
...
Result:
{
  "transactions": [
    ...
    "address":"address",    (string) The primeai address of the transaction. Not present for move transactions (category = move).
    "category":"send|receive",     (string) The transaction category. 'send' has negative amounts, 'receive' has positive amounts.
    "amount": x.xxx,          (numeric) The amount in PrimeAI. This is negative for the 'send' category, and for the 'move' category for moves 
                                          outbound. It is positive for the 'receive' category, and for the 'move' category for inbound funds.
    "vout" : n,               (numeric) the vout value
    "fee": x.xxx,             (numeric) The amount of the fee in PrimeAI. This is negative and only available for the 'send' category of transactions.
...
Examples:
> primeai-cli listsinceblock 
> primeai-cli listsinceblock "000000000000000bacf66f7497b7dc45ef753ee9a7d38571037cdb1a57f663ad" 6
...
Examples:
> primeai-cli listsnapshotrequests 
...
Examples:
> primeai-cli listtagsforaddress "address"
...
[
  {
    ...
    "address":"address",    (string) The primeai address of the transaction. Not present for 
                                                move transactions (category = move).
    "category":"send|receive|move", (string) The transaction category. 'move' is a local (off blockchain)
                                                transaction between accounts, and not associated with an address,
                                                transaction id or block. 'send' and 'receive' transactions are 
                                                associated with an address, transaction id and block details
    "amount": x.xxx,          (numeric) The amount in PrimeAI. This is negative for the 'send' category, and for the
...
> primeai-cli listtransactions 

List transactions 100 to 120
> primeai-cli listtransactions "*" 20 100
...
3. "addresses"      (string) A json array of primeai addresses to filter
    [
      "address"     (string) primeai address
      ,...
    ]
...
5. query_options    (json, optional) JSON with query options
    {
      "minimumAmount"    (numeric or string, default=0) Minimum value of each UTXO in PrimeAI
      "maximumAmount"    (numeric or string, default=unlimited) Maximum value of each UTXO in PrimeAI
      "maximumCount"     (numeric or string, default=unlimited) Maximum number of UTXOs
      "minimumSumAmount" (numeric or string, default=unlimited) Minimum sum value of all UTXOs in PrimeAI
    }
...
[                   (array of json object)
  {
    ...
    "vout" : n,               (numeric) the vout value
    "address" : "address",    (string) the primeai address
    "account" : "account",    (string) DEPRECATED. The associated account, or "" for the default account
    "scriptPubKey" : "key",   (string) the script key
    "amount" : x.xxx,         (numeric) the transaction output amount in PrimeAI
    "confirmations" : n,      (numeric) The number of confirmations
...
Examples
> primeai-cli listunspent 
> primeai-cli listunspent 6 9999999 "[\"1PGFqEzfmQch1gKD3ra4k18PNj3tTUUSqg\",\"1LtvqCaApEdUGFkpKMM4MstjcaL4dKg8SP\"]"
...
> primeai-cli listunspent 6 9999999 '[]' true '{ "minimumAmount": 0.005 }'
...
A locked transaction output will not be chosen by automatic coin selection, when spending primeais.
...
3. amount            (numeric) Quantity of PrimeAI to move between accounts.
...
Move 0.01 PrimeAI from the default account to the account named tabby
> primeai-cli move "" "tabby" 0.01

Move 0.01 PrimeAI timotei to akiko with a comment and funds have 6 confirmations
> primeai-cli move "timotei" "akiko" 0.01 6 "happy birthday!"
...
Examples:
> primeai-cli pprpcsb "header_hash" "mix_hash" 100000
...
Examples:
> primeai-cli preciousblock "blockhash"
...
Examples:
> primeai-cli prioritisetransaction "txid" 0.0 10000
...
Examples:
> primeai-cli pruneblockchain 1000
...
Examples:
> primeai-cli purgesnapshot "ASSET_NAME" 28546
...
Examples:
> primeai-cli reissue "ASSET_NAME" 20 "address"
...
6. "change_address"        (string, optional, default="") address that the primeai change will be sent to, if it is empty, change address will be generated for you
...
Examples:
> primeai-cli reissuerestrictedasset "$ASSET_NAME" 1000  "myaddress" true "KYC & !AML"
> primeai-cli reissuerestrictedasset "$ASSET_NAME" 1000  "myaddress" true "KYC & !AML" 
> primeai-cli reissuerestrictedasset "$ASSET_NAME" 1000  "myaddress" true "KYC & !AML" "changeaddress"
> primeai-cli reissuerestrictedasset "$ASSET_NAME" 1000  "myaddress" true "KYC & !AML" "changeaddress" -1 true
> primeai-cli reissuerestrictedasset "$ASSET_NAME" 1000  "myaddress" false "" "changeaddress" -1 false QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E
**/
...
Examples:
> primeai-cli removeprunedfunds "a8d0c0184dde994a09ec054286f1ce581bebf46446a512166eae7628734ea0a5"
...
Examples:
> primeai-cli removetagfromaddress "#TAG" "to_address"
...
> primeai-cli removetagfromaddress "#TAG" "to_address" "change_address"
...
Examples:
> primeai-cli requestsnapshot "TRONCO" 12345
...
Examples:
> primeai-cli rescanblockchain 100000 120000
...
DEPRECATED (use sendtoaddress). Sent an amount from an account to a primeai address.
...
1. "fromaccount"       (string, required) The name of the account to send funds from. May be the default account using "".
                       ...
                       the spend.
2. "toaddress"         (string, required) The primeai address to send funds to.
3. amount                (numeric or string, required) The amount in PrimeAI (transaction fee is added on top).
...
Send 0.01 PrimeAI from the default account to the address, must have at least 1 confirmation
> primeai-cli sendfrom "" "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.01

Send 0.01 from the tabby account to the given address, funds must have at least 6 confirmations
> primeai-cli sendfrom "tabby" "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.01 6 "donation" "seans outpost"
...
Send an amount from a specific address to a given address. All primeai change will get sent back to the from_address

Arguments:
1. "from_address"       (string, required) The primeai address to send from.
2. "to_address"            (string, required) The primeai address to send to.
3. "amount"             (numeric or string, required) The amount in PrimeAI to send. eg 0.1
...
6. subtractfeefromamount  (boolean, optional, default=false) The fee will be deducted from the amount being sent.
                             The recipient will receive less primeais than you enter in the amount field.
...
Examples:
> primeai-cli sendfromaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1
> primeai-cli sendfromaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1 "donation" "seans outpost"
> primeai-cli sendfromaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1 "" "" true
...
2. "amounts"             (string, required) A json object with addresses and amounts
    {
      "address":amount   (numeric or string) The primeai address is the key, the numeric amount (can be string) in PrimeAI is the value
      ,...
    }
...
> primeai-cli sendmany "" "{\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\":0.01,\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\":0.02}"

Send two amounts to two different addresses setting the confirmation and comment:
> primeai-cli sendmany "" "{\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\":0.01,\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\":0.02}" 6 "testing"

Send two amounts to two different addresses, subtract fee from amount:
> primeai-cli sendmany "" "{\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\":0.01,\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\":0.02}" 1 "" "[\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\",\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\"]"
...
Examples:
> primeai-cli sendmessage "ASSET_NAME!" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 15863654
> primeai-cli sendmessage "ASSET_NAME!" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 15863654
**/
...
> primeai-cli createrawtransaction "[{\"txid\" : \"mytxid\",\"vout\":0}]" "{\"myaddress\":0.01}"
Sign the transaction, and get back the hex
> primeai-cli signrawtransaction "myhex"

Send the transaction (signed hex)
> primeai-cli sendrawtransaction "signedhex"
...
Arguments:
1. "address"            (string, required) The primeai address to send to.
2. "amount"             (numeric or string, required) The amount in PrimeAI to send. eg 0.1
...
Examples:
> primeai-cli sendtoaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1
> primeai-cli sendtoaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1 "donation" "seans outpost"
> primeai-cli sendtoaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1 "" "" true
...
Arguments:
1. "address"         (string, required) The primeai address to be associated with an account.
2. "account"         (string, required) The account to assign the address to.

Examples:
> primeai-cli setaccount "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" "tabby"
...
Examples:
> primeai-cli setban "192.168.0.6" "add" 86400
> primeai-cli setban "192.168.0.0/24" "add"
...
> primeai-cli setgenerate true 1

Check the setting
> primeai-cli getgenerate 

Turn off generation
> primeai-cli setgenerate false
...
Arguments:
1. amount         (numeric or string, required) The transaction fee in PrimeAI/kB

Result
true|false        (boolean) Returns true if successful

Examples:
> primeai-cli settxfee 0.00001
...
Arguments:
1. "address"         (string, required) The primeai address to use for the private key.
...
> primeai-cli walletpassphrase "mypassphrase" 30

Create the signature
> primeai-cli signmessage "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" "my message"

Verify the signature
> primeai-cli verifymessage "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" "signature" "my message"
...
Create the signature
> primeai-cli signmessagewithprivkey "privkey" "my message"
...
See https://en.primeai.it/wiki/BIP_0022 for full specification.
...
Examples:
> primeai-cli submitblock "mydata"
...
Examples:
> primeai-cli subscribetochannel "ASSET_NAME!"
...
> primeai-cli testmempoolaccept "signedhex"
...
6. "change_address"       (string, optional, default = "") the transactions PrimeAI change will be sent to this address
...
Examples:
> primeai-cli transfer "ASSET_NAME" 20 "address" "" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 15863654
> primeai-cli transfer "ASSET_NAME" 20 "address" "" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 15863654
**/
transfer:'transfer',
...
/** transferfromaddress "asset_name" "from_address" qty "to_address" "message" expire_time "primeai_change_address" "asset_change_address"
...
7. "primeai_change_address"       (string, optional, default = "") the transaction PrimeAI change will be sent to this address
...
Examples:
> primeai-cli transferfromaddress "ASSET_NAME" "fromaddress" 20 "address" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E", 156545652
...
/** transferfromaddresses "asset_name" ["from_addresses"] qty "to_address" "message" expire_time "primeai_change_address" "asset_change_address"
...
5. "message"                  (string, optional) Once RIP5 is voted in ipfs hash or txid hash to send along with the transfer
6. "expire_time"              (numeric, optional) UTC timestamp of when the message expires
7. "primeai_change_address"       (string, optional, default = "") the transactions PrimeAI change will be sent to this address
...
Examples:
> primeai-cli transferfromaddresses "ASSET_NAME" '["fromaddress1", "fromaddress2"]' 20 "to_address" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 154652365
...
Examples:
> primeai-cli transferqualifier "#QUALIFIER" 20 "to_address" "" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 15863654
> primeai-cli transferqualifier "#QUALIFIER" 20 "to_address" "change_address" "QmTqu3Lk3gmTsQVtjU7rYYM37EAW4xNmbuEAp2Mjr4AV7E" 15863654
**/
...
Examples:
> primeai-cli unfreezeaddress "$RESTRICTED_ASSET" "address"
...
> primeai-cli unfreezeaddress "$RESTRICTED_ASSET" "address" "change_address"
...
Examples:
> primeai-cli unfreezerestrictedasset "$RESTRICTED_ASSET"
...
> primeai-cli unfreezerestrictedasset "$RESTRICTED_ASSET" "change_address"
...
Examples:
> primeai-cli unsubscribefromchannel "ASSET_NAME!"
...
Return information about the given primeai address.

Arguments:
1. "address"     (string, required) The primeai address to validate

Result:
{
  "isvalid" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.
  "address" : "address", (string) The primeai address validated
...
Examples:
> primeai-cli validateaddress "1PSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc"
...
Arguments:
1. "address"         (string, required) The primeai address to use for the signature.
...
Examples:
> primeai-cli viewallmessagechannels 
...
Examples:
> primeai-cli viewmyrestrictedaddresses 
...
Examples:
> primeai-cli viewmytaggedaddresses 
